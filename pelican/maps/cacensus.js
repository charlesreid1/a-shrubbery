...
////// to add just the plain old boring default style states:
////L.geoJson(statesData, {style: style}).addTo(map);


// set the color of state based on property "density"
// add popups etc
//
...
function style(feature) {
    return {
        fillColor: getColor(feature.properties.density/200.0),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
...
// now apply style to each of our states
L.geoJson(statesData, {style: style}).addTo(map);
